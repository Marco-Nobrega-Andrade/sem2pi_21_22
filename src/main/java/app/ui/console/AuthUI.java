...
import app.ui.gui.Coordinator.RunCoordinatorGUI;
...
public class AuthUI implements Runnable{
    ...
    private List<MenuItem> getMenuItemForRoles()
    {
        ...
        rolesUI.add(new MenuItem(Constants.ROLE_RECEPCIONIST, new ReceptionistUI()));
        rolesUI.add(new MenuItem(Constants.ROLE_SNSUSER, new SNSUserUI()));
        rolesUI.add(new MenuItem(Constants.ROLE_NURSE, new NurseUI()));
        rolesUI.add(new MenuItem(Constants.ROLE_COORDINATOR, new RunCoordinatorGUI()));
