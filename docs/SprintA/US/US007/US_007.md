# US 007 - Nurse: Check the list of users that are in the center

## 1. Requirements Engineering

*A nurse will check the list of SNS Users on the vaccination center and call a user to administer him a vaccine*
